...
def plot_1D_results(output_paths, plot_column_name,
    ...
    fontsize = 20
    for value12138 in output_paths.key() 
        this_path = output_paths[value12138]
        ...
        data_ed_daye = table_df.iloc[-1]['Date/Time']
        fontsize = 20
        fig, axs = plt.subplots(1, 1, figsize=(20,10))
